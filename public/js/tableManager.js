        ...
        if (options !== null) {
            ...
            **/
            ...
            if (
                ...
                // div num rows
                var numrowsDiv =
                    '<div id="for_numrows" class="mx-3 for_numrows" style="display: inline;"><label for="numrows">' +
                    translate(voc_show_rows) +
                    ': </label><select id="numrows" class="mx-3"></select></div>';
            ...
            **/
            if (pagination === true || Table.hasClass("tablePagination")) {
                ...
                var pagesDiv =
                    '<div id="pagesControllers" class="pagesControllers mt-3 float-end"></div>';
        ...
        function appendPageControllers(nPages) {
            ...
            $("#pagesControllers").append(
                $("<button>", {
                    value: "first",
                    text: "first",
                    class: "btn btn-sm btn-outline-primary border border-secondary rounded-0 rounded-start pagecontroller pagecontroller-f",
                })
            );
            // Previous
            $("#pagesControllers").append(
                $("<button>", {
                    value: "prev",
                    text: "<",
                    class: "btn btn-sm btn-outline-primary border border-secondary rounded-0 pagecontroller pagecontroller-p",
                })
            );
            // Numbers
            for (i = 1; i <= nPages; i++) {
                $("#pagesControllers").append(
                    $("<button>", {
                        value: i,
                        text: i,
                        class: "btn btn-sm btn-outline-primary border border-secondary rounded-0 pagecontroller pagecontroller-num",
                    })
                );
            }
            // Next
            $("#pagesControllers").append(
                $("<button>", {
                    value: "next",
                    text: ">",
                    class: "btn btn-sm btn-outline-primary border border-secondary rounded-0 pagecontroller pagecontroller-n",
                })
            );
            // Last
            $("#pagesControllers").append(
                $("<button>", {
                    value: "last",
                    text: "last", 
                    class: "btn btn-sm btn-outline-primary border border-secondary rounded-0 rounded-end pagecontroller pagecontroller-l",
                })
            );
        }
