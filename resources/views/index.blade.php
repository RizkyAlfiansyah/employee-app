        ...
        <div class="row justify-content-center bg-light mb-3">
            ...
            <div id="fetch-data">
                <div class="row justify-content-center my-2">
                    <div class="col lg-4">
                        <table class="table my-2" id="tableManager">
                            <thead class="bg-dark mx-2" style="color: aliceblue">
                              <tr>
                                <th>No.</th>
                                <th>Nama</th>
                                <th>Gaji</th>
                            ...
                            <tbody id="fetch" class="text-uppercase">
        ...
        <div class="modal-body">
            <form id="addPost">
                ...
                <div class="form-group my-2">
                        <input oninput="this.value = this.value.toCapitalize()" type="text" class="form-control" id="name" placeholder="Nama" required>
                    </div>
